        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfCreateon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GroupId = table.Column<int>(type: "int", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupsWithVersion", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GroupWithVersionId = table.Column<int>(type: "int", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubgroupsWithVersion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubgroupsWithVersion_GroupsWithVersion_GroupWithVersionId",
                        column: x => x.GroupWithVersionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeachersNames = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SubjectForm = table.Column<int>(type: "int", nullable: false),
                    HasCoursework = table.Column<bool>(type: "bit", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Relations_Semesters_SemesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Module1 = table.Column<int>(type: "int", nullable: false),
                    Module2 = table.Column<int>(type: "int", nullable: false),
                    ExamOrTest = table.Column<int>(type: "int", nullable: false),
                    Coursework = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Marks_Relations_RelationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserRelation_AspNetUsers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRelation_Relations_RelationId",
                        column: x => x.RelationId,
                        principalTable: "Relations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupsWithVersion_GroupId",
                table: "GroupsWithVersion",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Marks_RelationId",
                table: "Marks",
                column: "RelationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Relations_SemesterId",
                table: "Relations",
                column: "SemesterId");

            migrationBuilder.CreateIndex(
                name: "IX_Relations_SubgroupId",
                table: "Relations",
                column: "SubgroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRelation_RelationId",
                table: "UserRelation",
                column: "RelationId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRelation_TeacherId",
                table: "UserRelation",
                column: "TeacherId");
        }
